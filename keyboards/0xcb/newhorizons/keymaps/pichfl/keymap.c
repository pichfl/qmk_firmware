...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        DE_CIRC, KC_1,    KC_2   , KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, DE_ACUT, _______, KC_BSPC, RGB_TOG,
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC , MO(1)  , KC_SPC,                    KC_RGUI, KC_RALT, MO(1)  , KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_all(
        ...
        _______,       _______, _______,                   MO(2)  , _______, MO(2)  ,                   RCTL(KC_RGUI), RCTL(KC_RALT), _______      , RCTL(KC_LEFT), RCTL(KC_DOWN), RCTL(KC_RGHT)
    ),
    [2] = LAYOUT_all(
